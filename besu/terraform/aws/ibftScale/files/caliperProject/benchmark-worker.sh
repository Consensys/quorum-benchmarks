...
node "$SCRIPTDIR"/../caliper/packages/caliper-cli/caliper.js launch worker --caliper-benchconfig "$BENCHMARK_SCRIPT" --caliper-networkconfig config/networkconfig.json --caliper-workspace "$SCRIPTDIR"
